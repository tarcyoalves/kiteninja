...
export const INITIAL_SPOTS: Spot[] = [
  ...
  {
    id: 'gado-bravo',
    name: 'Praia de Gado Bravo',
    location: 'Gado Bravo / Tibau / RN',
    state: 'RN',
    country: 'Brasil',
    countryFlag: '🇧🇷',
    lat: -4.842,
    ...
    windSafety: 'Side-Onshore',
    temperature: 28,
    weatherDescription: 'Estação ao vivo Gado Bravo',
    weatherIcon: 'sun',
    isLiveObservation: true,
    stationName: 'Gado Bravo - Tibau',
    stationProvider: 'WindRadar / Estação Física',
    lastUpdated: '14:26',
    lastUpdatedFull: '18/08/2026 às 14:26 - (-3 UTC)',
    nextUpdate: 'Ao Vivo (4min)',
    currentTideHeightM: 0.32,
    currentTideTrend: 'subindo',
    nextTideInfo: 'Próxima maré: 0.64m',
    nextTideHeightM: 0.64,
    waveHeightM: 0.8,
    wavePeriodS: 5,
    waterCondition: 'Chop Médio',
    bottomType: 'Areia',
  ...
  },
  {
    ...
    name: 'Pousada Quilombo do Tibau',
    location: 'Praia das Emanuelas / Tibau / RN',
    state: 'RN',
    country: 'Brasil',
    countryFlag: '🇧🇷',
    lat: -4.835,
    ...
    windSafety: 'Side-Onshore',
    temperature: 28,
    weatherDescription: 'Estação ao vivo Pousada Quilombo',
    weatherIcon: 'sun',
    isLiveObservation: true,
    stationName: 'Pousada Quilombo do Tibau',
    stationProvider: 'WindRadar / Estação Física',
    lastUpdated: '14:26',
    lastUpdatedFull: '18/08/2026 às 14:26 - (-3 UTC)',
    nextUpdate: 'Ao Vivo (4min)',
  ...
  },
  {
    ...
    name: 'Soledade Bangalôs Kauli Seadi',
    location: 'Praia de Soledade / Macau / RN',
    state: 'RN',
    country: 'Brasil',
    countryFlag: '🇧🇷',
    lat: -5.115,
    ...
    windSafety: 'Side-Shore',
    temperature: 29,
    weatherDescription: 'Estação ao vivo Bangalôs Kauli Seadi',
    weatherIcon: 'sun',
    isLiveObservation: true,
    stationName: 'Soledade Bangalôs Kauli Seadi',
    stationProvider: 'WindRadar / Estação Física',
    lastUpdated: '14:26',
    lastUpdatedFull: '18/08/2026 às 14:26 - (-3 UTC)',
    nextUpdate: 'Ao Vivo (4min)',
    currentTideHeightM: 0.32,
    currentTideTrend: 'subindo',
    nextTideInfo: 'Próxima maré: 0.73m',
    nextTideHeightM: 0.73,
    waveHeightM: 0.5,
    wavePeriodS: 4,
    waterCondition: 'Flat / Lagoa',
    bottomType: 'Areia',
  ...
  },
  {
    ...
    windSafety: 'Side-Onshore',
    temperature: 28,
    weatherDescription: 'Vento constante do litoral de Tibau',
    weatherIcon: 'sun',
    isLiveObservation: true,
    stationName: 'Tibau - Litoral Norte',
    stationProvider: 'Estação Meteorológica RN',
    lastUpdated: '14:26',
    lastUpdatedFull: '18/08/2026 às 14:26 - (-3 UTC)',
    nextUpdate: 'Ao Vivo (4min)',
    currentTideHeightM: 0.32,
  ...
  },
  {
    ...
    windSafety: 'Side-Onshore',
    temperature: 28,
    weatherDescription: 'Lagoa de Guaraíras e mar aberto',
    weatherIcon: 'sun',
    isLiveObservation: true,
    stationName: 'Tibau do Sul - Guaraíras',
    stationProvider: 'Estação Litoral Sul RN',
    lastUpdated: '14:26',
    lastUpdatedFull: '18/08/2026 às 14:26 - (-3 UTC)',
    nextUpdate: 'Ao Vivo (4min)',
    currentTideHeightM: 0.45,
    currentTideTrend: 'subindo',
    nextTideInfo: 'Próxima maré: 1.2m',
    nextTideHeightM: 1.2,
    waveHeightM: 1.1,
    wavePeriodS: 6,
    waterCondition: 'Flat / Lagoa',
